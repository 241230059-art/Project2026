<header class="bg-pink-50 shadow-sm">
  <div class="container mx-auto flex justify-between items-center p-4">
    ...
    <nav class="space-x-6">
      ...
      <a href="/donasi" class="text-gray-600 hover:text-pink-500 transition">Donasi</a>
      <a href="/profil" class="text-gray-600 hover:text-pink-500 transition">Profil</a>
      <a href="/kontak" class="text-gray-600 hover:text-pink-500 transition">Kontak</a>
    </nav>
